...
const codewars = document.getElementById("card__codewars");
...
toggleTheme.addEventListener("click", () => {
  ...
  if (toggleIcon.src.includes("moon.svg")) {
    ...
    codewars.src = "https://www.codewars.com/users/ALEXSUHARI/badges/large";
  } else {
    toggleIcon.src = "assets/icons/moon.svg";
    rootStyle.setProperty("--primary-color", "hsl(150,84%,56%)");
    codewars.src =
      "https://www.codewars.com/users/ALEXSUHARI/badges/large?theme=light";
  }
});
...
toggleProjects.addEventListener("click", () => {
  if (isJavascriptDisplayed == false) {
    ...
    toggleProjectsText.setAttribute(
      "data-value",
      "javascriptProjectsIcon__text"
    );
